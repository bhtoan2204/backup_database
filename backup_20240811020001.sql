...
-- Started on 2024-08-11 02:00:01 UTC
...
19	96	f88129b8-5779-48b7-be5d-2ee2d198dd19
\.
...
SELECT pg_catalog.setval('public.family_invitation_id_invitation_seq', 19, true);
...
SELECT pg_catalog.setval('public.finance_expenditure_id_expenditure_seq', 324, true);
...
SELECT pg_catalog.setval('public.finance_income_id_income_seq', 295, true);
...
SELECT pg_catalog.setval('public.shopping_items_id_item_seq', 189, true);
...
SELECT pg_catalog.setval('public.shopping_lists_id_list_seq', 82, true);
...
SELECT pg_catalog.setval('public.utilities_id_utility_seq', 134, true);
...
-- Completed on 2024-08-11 02:00:02 UTC
